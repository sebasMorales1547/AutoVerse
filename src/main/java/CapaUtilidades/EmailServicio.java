...
public class EmailServicio {
    ...
    public void enviar(String destinatario, String asunto, String cuerpoHtml) throws MessagingException {
        Session session = crearSesion();

        Message mensaje = new MimeMessage(session);
        mensaje.setFrom(new InternetAddress(
            EmailConfig.CORREO_REMITENTE, EmailConfig.NOMBRE_SISTEMA
